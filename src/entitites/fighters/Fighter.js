...
export class Fighter {
	...
	handleWalkForward = () => {
		!control.isForward(this.playerId, this.direction) && this.changeState(FighterState.IDLE);
	...
	hanldeWalkBackward = () => {
		!control.isBackward(this.playerId, this.direction) && this.changeState(FighterState.IDLE);
